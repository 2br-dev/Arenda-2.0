        ...
        {loading ? <Loader></Loader> : (<React.Fragment>
          ...
          <div className='container' style={{ 'width':'700px '}}>
            <div>
              ...
              <p style={{'marginTop':'0'}}>Текущий баланс: <span style={renter.balance >= 0 ? {'color':'green'} : {'color':'red'}}> {renter.balance}₽</span></p>
            </div>
            ...
            {store.invoices.map((invoice,i) => {
              ...
              <div onClick={this.toggleInvoice}>
                <p className='toggle' style={{ 'marginTop':'30px','marginBottom':'0'}} >
                  № счёта: {invoice.invoice_number} за {invoice.period_month}, {invoice.period_year}, на сумму: {invoice.summa}
                </p>
                <hr />
